...
If you want to show the results of the tests in the storybook preview just run `npm run test:generate-output` and uncomment all comments below line 3 in the *.stories.ts files before you run `npm start`.